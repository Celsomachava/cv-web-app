    ...
    return `
        ...
        <div class="creative-template">
            <div class="sidebar">
                ...
                ${data.personal.address ? `<div class="contact-line"><div class="contact-icon"><i class="fa-solid fa-location-dot"></i></div><span class="contact-text">${data.personal.address}${data.personal.city ? `, ${data.personal.city}` : ''}${data.personal.postcode ? ` ${data.personal.postcode}` : ''}${data.personal.country ? `, ${data.personal.country}` : ''}</span></div>` : (data.personal.city || data.personal.postcode || data.personal.country) ? `<div class="contact-line"><div class="contact-icon"><i class="fa-solid fa-location-dot"></i></div><span class="contact-text">${data.personal.city || ''}${data.personal.postcode ? ` ${data.personal.postcode}` : ''}${data.personal.country ? `, ${data.personal.country}` : ''}</span></div>` : ''}
            ...
            <div class="main-content">
                ...
                ${data.certifications.length > 0 ? `<div class="section-title-main">${t.certifications}</div>${data.certifications.map(cert => `<div class="experience-item"><div class="exp-title">${cert.name}</div><div class="exp-company">${cert.issuer}${cert.credentialId ? ` • ID: ${cert.credentialId}` : ''}</div><div class="exp-date">${cert.date}</div></div>`).join('')}` : ''}
            </div>
        </div>
        </body>
        </html>
